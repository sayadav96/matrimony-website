    ...
    <div className="min-h-screen py-6">
      ...
      {showFilters && (
        <div className="fixed inset-0 z-50">
          ...
          <div className="absolute inset-y-0 left-0 w-[90%] max-w-[360px] shadow-xl rounded-r-2xl overflow-hidden" style={{ backgroundColor: "#fff" }}>
            <div className="px-4 py-3 font-semibold border-b" style={{ backgroundColor: COLORS.light }}>
              Filters
            </div>
            <div className="p-4 space-y-4 text-sm">
              ...
              />
              <Text label="City" value={filters.city} onChange={(v) => setFilters({ ...filters, city: v })} />
              <Text label="Community" value={filters.community} onChange={(v) => setFilters({ ...filters, community: v })} />
              <div className="grid grid-cols-2 gap-2">
                <Text label="Age min" type="number" value={filters.ageMin} onChange={(v) => setFilters({ ...filters, ageMin: v })} />
                <Text label="Age max" type="number" value={filters.ageMax} onChange={(v) => setFilters({ ...filters, ageMax: v })} />
              </div>

              <div className="pt-2 grid grid-cols-2 gap-2">
                <button
                  onClick={() => {
                    const cleared = { gender: "", city: "", community: "", ageMin: "", ageMax: "" };
